...
@Component({
  ...
  template: `
    <div class="pt-24 pb-20 bg-white">
      ...
      <!-- Featured Posts -->
      <section
        *ngIf="featuredPosts.length > 0"
        class="container mx-auto px-6 mb-20"
      >
        <h2 class="text-2xl font-bold text-neutral-900 mb-8">Featured Posts</h2>
          ...
          >
            ...
            <div class="p-6">
              <div class="flex items-center text-sm text-neutral-500 mb-3">
                ...
                <span *ngIf="post.reading_time" class="mx-2">•</span>
                <span *ngIf="post.reading_time"
      ...
      <section class="container mx-auto px-6">
        <div class="flex items-center justify-between mb-8">
          <h2 class="text-2xl font-bold text-neutral-900">All Posts</h2>
        ...
        <div *ngIf="!loading && blogPosts.length > 0" class="space-y-8">
          <article
          ...
          >
            <div class="md:flex">
              <div class="md:w-1/3">
                <div
                  class="aspect-video md:aspect-square bg-gradient-to-br from-primary-100 to-primary-200 overflow-hidden"
                >
                  <img
                    *ngIf="post.featured_image; else placeholderImage"
                    [src]="getImageUrl(post.featured_image)"
        ...
        <!-- Load More Button -->
        <div
          *ngIf="!loading && blogPosts.length > 0 && hasMore"
          class="text-center mt-12"
        >
          <button
            (click)="loadMore()"
            [disabled]="loadingMore"
            class="bg-neutral-200 hover:bg-neutral-300 text-neutral-800 px-8 py-3 rounded-lg font-medium transition-colors disabled:opacity-50"
          >
      ...
      <!-- Newsletter Signup -->
      <section class="bg-gradient-to-r from-primary-600 to-primary-700 mt-20">
